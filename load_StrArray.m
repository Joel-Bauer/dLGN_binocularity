...
Key_variables  = {'animal_name', 'patching_date', 'slice_nr', 'cellname', ...
    'eye_inj_ord', 'brain_contra_ipsi', 'hemisphere','dLGN_contra_zone','dLGN_ipsi_zone','ccfv3_pos'}; % these are always loaded, and place at the top of the strucutre
...
elseif strcmp(inclusion_fields,'ExcludeField')
    fields = cat(2,Key_variables,varibale_list(~ismember(varibale_list,Key_variables))');
    fields(ismember(fields,fields_idx)) = [];
end
